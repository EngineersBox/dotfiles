...
let s:last_modified = 'Fri Dec 23 13:21:27 UTC 2022'
...
call sonokai#highlight('RedVT', s:palette.red, s:palette.diff_red)
...
call sonokai#highlight('YellowVT', s:palette.yellow, s:palette.diff_yellow)
call sonokai#highlight('Green', s:palette.green, s:palette.none)
call sonokai#highlight('GreenVT', s:palette.green, s:palette.diff_green)
call sonokai#highlight('Blue', s:palette.blue, s:palette.none)
call sonokai#highlight('BlueVT', s:palette.blue, s:palette.diff_blue)
...
if s:configuration.diagnostic_virtual_text ==# 'grey'
  ...
  highlight! link VirtualTextWarning YellowVT
  highlight! link VirtualTextError RedVT
  highlight! link VirtualTextInfo BlueVT
  highlight! link VirtualTextHint GreenVT
endif
